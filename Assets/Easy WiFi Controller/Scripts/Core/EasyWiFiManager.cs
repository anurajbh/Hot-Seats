...
public class EasyWiFiManager : MonoBehaviour
{
    ...
    public void sendScanInstruction() //sends a "scan" instruction to all client devices
    {
        EasyWiFiController.sendScanInstruction();
    }
    ...
    void Start()
    {
        ...
        else
        {
            ...
            EasyWiFiController.OnScanInstructionReceived += new EasyWiFiController.OnScanInstructionReceivedHandler(receiveScanData);

        }
    }

    void receiveScanData(ScanResult r)
    {
        Debug.Log("Scan Result Received: " + r.result);
    }
    ...
    public void sendClientBluetoothData(string bluetoothScanResult)
    {
        Debug.Log("WIFI MANAGER: SENDING BLUETOOTH RESULT");
        EasyWiFiController.sendWiFIControllerData(bluetoothScanResult);

        //increment the packet number

    }

    public void recordBluetoothMessage(string msg)
    {
        Debug.Log(msg);
    }
